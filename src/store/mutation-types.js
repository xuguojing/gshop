...
export const RECEIVE_USER_INFO = 'receive_user_info'  //接收登陆信息
...
export const CLEARCART_FOODCART = 'clearcart_foodcart' // 减少food中的count

export const RECEIVE_SEARCH_SHOPS = 'receive_search_shops' // 接收搜索商铺